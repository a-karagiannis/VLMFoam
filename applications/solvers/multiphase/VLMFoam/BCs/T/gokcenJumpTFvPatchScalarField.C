...
#include "gokcenJumpTFvPatchScalarField.H"
...
Foam::gokcenJumpTFvPatchScalarField::gokcenJumpTFvPatchScalarField
(
    const fvPatch& p,
...
Foam::gokcenJumpTFvPatchScalarField::gokcenJumpTFvPatchScalarField
(
    const gokcenJumpTFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::gokcenJumpTFvPatchScalarField::gokcenJumpTFvPatchScalarField
(
    const gokcenJumpTFvPatchScalarField& ptpsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
// Map from self
void Foam::gokcenJumpTFvPatchScalarField::autoMap
(
...
void Foam::gokcenJumpTFvPatchScalarField::rmap
(
...
void Foam::gokcenJumpTFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
// Write
void Foam::gokcenJumpTFvPatchScalarField::write(Ostream& os) const
{
